...
import motionVideo from '../assets/video/Motion Animation.mp4'
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-12 md:mb-16">
          {categories.map((cat) => (
            <button
              ...
              className={`px-5 sm:px-6 py-2.5 text-xs sm:text-sm font-medium rounded-full tracking-wider uppercase transition-all duration-300 ${
                activeCategory === cat
